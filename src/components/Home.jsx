...
function Home() {
  ...
  <HoverCardContent className='bg-[#FF5E5B] border border-black rounded p-4'>
  <div className='wizardry-description' style={{ color: 'black', padding: '2rem' }}>
    I went with a complete UI theme based on wizardry and magic in the coding realm. A bit cringe, but <em>cool</em>! 🤭
    </div>
  </HoverCardContent>
</HoverCard>
&nbsp; theme. <br/> You can view the old version <a href="https://wizardry.thajucp.in/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--blue)', fontWeight: 'bold', textDecoration: 'underline' }}>here</a>.</p>
        </div>
